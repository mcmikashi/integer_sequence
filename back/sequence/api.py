...
class SequenceBaseView(APIView):
    ...
    default_error_message = \
        """You send an invalid index.
        Index SHOULD be between 0 and 1000 included."""
    ...
    def get(self, request, index):
        ...
        with Update_Recursion_Limit(self.max_recursion_limit):
            try:
                ...
                raise NotFound(detail=self.default_error_message, code=404)
...
class DyingRabbitsView(SequenceBaseView):
    """
